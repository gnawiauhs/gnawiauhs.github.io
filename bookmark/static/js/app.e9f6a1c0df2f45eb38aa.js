  ...
  NHnr: function(t, i, s) {
      ...
      n = {
        render: function() {
          ...
          return s("div", {
            ...
            class: {
              active: -1 === t.curTopIndex && -1 === t.curSubIndex
            },
            attrs: {
              href: "javascript:;"
            },
            ...
            staticClass: "icon icon-zh_strong"
          }), t._v("综合推荐")])]), t._v(" "), t._l(t.bookmarks, function(i, e) {
            return s("li", {
              key: e,
              staticClass: "top-item"
            }, [s("a", {
              staticClass: "top-name",
              class: {
                active: t.curTopIndex === e && -1 === t.curSubIndex
              },
              attrs: {
                href: "javascript:;"
              },
              on: {
                click: function(s) {
                  t.updateList(i.type, -1)
                }
              }
            }, [s("i", {
              staticClass: "icon",
              class: i.icon
            }), t._v(t._s(i.name))]), t._v(" "), i.sublist || i.sublist.length > 0 ? s("ul", {
              staticClass: "sub-list"
            }, t._l(i.sublist, function(n, c) {
              return s("li", {
                key: c,
                ...
                class: {
                  active: e === t.curTopIndex && c === t.curSubIndex
                },
                attrs: {
                  href: "javascript:;"
                },
            ...
            return s("a", {
              ...
              attrs: {
                width: "40",
                height: "40",
                src: i.pic && "" !== i.pic ? i.pic : t.defaultPic,
                onerror: "this.onerror='';src='./static/imgs/default.png'"
              }
            })]), t._v(" "), s("div", {
              staticClass: "title"
            }, [s("span", {
    ...
    var c = s("Aizv")({
        ...
        computed: {
          curList: function() {
            var t = [];
            return -1 === this.curTopIndex ? this.bookmarks.forEach(function(i) {
              i.sublist.forEach(function(i) {
                i.items.forEach(function(i) {
                  t.includes(i) || t.push(i)
                })
              })
            }) : -1 === this.curSubIndex ? this.bookmarks[this.curTopIndex].sublist.forEach(function(i) {
              i.items.forEach(function(i) {
                t.includes(i) || t.push(i)
              })
            }) : this.bookmarks[this.curTopIndex].sublist[this.curSubIndex].items.forEach(function(i) {
              t.includes(i) || t.push(i)
            }), t
          }
        },
        methods: {
          updateList: function(t, i) {
            this.curTopIndex = t, this.curSubIndex = i
          }
        }
      }, n, !1, function(t) {
        s("inPr")
      ...
      a = {
        render: function() {
          ...
          return i("div", {
            ...
            staticClass: "bm-header"
          }), this._v(" "), i("bookmarks")], 1)
        },
        staticRenderFns: []
      };
    var p = s("Aizv")(o, a, !1, function(t) {
      s("nrFI")
    }, null, null).exports;
    s("34KM");
